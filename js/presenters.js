...
const speakersData = [
  {
    description: 'Economist, Emeritus Professor at X DAle University, World Trade Specialist, Author of the best sellers "The Great Bargain',
  ...
  {
    description: 'Acclaimed Supply Chain Management Expert, Yvan Kosnietzov, is advocating for a new paradigm in the supply chain management',
  ...
  {
    description: 'Dr Nanotte Ben Nana, Economist, teaches Network Economics at Moussa University. Author of the best seller: "Bloosoming Network: The North Atlantic Port is a best seller in USA.',
  ...
  {
    description: 'Lipo Mennendez is an anthropologist, Columnist, Author of "You Broke it, You Own It". Mr Mennendez is the advocate of the Yagaga Native People.',
